...
//https://developer.twitter.com/en/portal/projects/1574884891803516928/apps/25574694/keys

import UIKit
import BDBOAuth1Manager

class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "sdh4MeE8NfSdwVd8kQ5XC1NuF", consumerSecret: "T1WV1h5mkiM9pu55ETNPrYsztD9ilqvi15dpbe0HJh9RZvTjTS")
    var loginSuccess: (() -> ())?
    ...
    func retwee(tweetId:Int, success: @escaping () -> (), failure: @escaping (Error) -> ()) {
