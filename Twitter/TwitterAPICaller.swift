...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "qwWwSiQtMWTONndh3Cngd7AVd", consumerSecret: "wJnMjY6OSnhSO9oDCuz3Y3FcBPG3Fg41QSytuI8xnLuSoSYIpT")
    var loginSuccess: (() -> ())?
